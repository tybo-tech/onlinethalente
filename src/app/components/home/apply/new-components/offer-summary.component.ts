  ...
  template: `
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24 space-y-5">
      ...
      <div class="p-3 rounded-lg"
           [ngClass]="isWindowOpen
                     ? 'bg-green-50 border border-green-200 text-green-700'
                     : 'bg-yellow-50 border border-yellow-200 text-yellow-700'">
        <div class="flex items-center gap-2">
          <i [ngClass]="isWindowOpen
      ...
      <ul class="space-y-2 text-sm text-gray-700">
        <li class="flex items-center gap-2">
          <i class="i-heroicons-check-badge text-emerald-600"></i>
          AI checks on documents
        </li>
        <li class="flex items-center gap-2">
          <i class="i-heroicons-banknotes text-emerald-600"></i>
